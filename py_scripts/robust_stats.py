...
as for some reason pip kept throwing errors when trying to download the whole lsl
package, so instead I just took the code for the functions I wanted.

CHANGED LINES 201/202 in 'mode' function -- needed an index to be an integer
